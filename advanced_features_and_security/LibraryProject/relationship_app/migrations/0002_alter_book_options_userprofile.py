...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='book',
            options={'permissions': [('can_add_book', 'Can add a new book to the catalog'), ('can_change_book', 'Can edit an existing book entry'), ('can_delete_book', 'Can delete a book entry')]},
        ),
