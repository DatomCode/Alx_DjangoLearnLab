...
urlpatterns = [
    ...
    path('add_book/', views.secured_book_add, name='book_add'),
    path('edit_book/<int:pk>/', views.secured_book_edit, name='book_edit'),
    path('delete_book/<int:pk>/', views.secured_book_delete, name='book_delete'),
]
